...
// VirtIO device features (bit positions)
...
function Virtio9p(filesystem, cpu, bus) {
    ...
    this.virtio = new VirtIO(cpu,
    {
        ...
        device_specific:
        {
            ...
            ].concat(this.configspace_tagname.map(value =>
                ({
                    bytes: 1,
                    name: "mount tag name",
                    read: () => value,
...
{
    // TODO: mount tagname not updated in IO port handlers
...
Virtio9p.prototype.ReceiveRequest = function (bufchain) {
    ...
    var buffer = new Uint8Array(bufchain.length_readable);
