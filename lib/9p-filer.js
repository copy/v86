...
Virtio9p.prototype.ReceiveRequest = async function (bufchain) {
    ...
    {
        case 8: // statfs
            // Copied over from the old source i'm using to port this:
            // Not sure if we want to get accurate sizing info from indexeddb
        ...
        case 118: // write
            ...
            fs.open(path, 'w', function(err, fd){
                ...
                var data = Buffer.from(buffer.subarray(state.offset));
