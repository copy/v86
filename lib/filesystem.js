...
FS.prototype.link_under_dir = function(parentid, idx, name)
{
    ...
    // Root inodes of other filesystems have already accounted for their nlinks (due to their '..').
    // Also, don't mess with other filesystem's nlinks.
    if(!this.is_a_root(idx))
    {
