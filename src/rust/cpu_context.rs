...
impl CpuContext {
    pub fn advance16(&mut self) {
        ...
        self.eip = increment_instruction_pointer(self.eip as i32, 2, self.asize_32(), self.cs_offset as i32) as u32;
    }
    pub fn advance32(&mut self) {
        dbg_assert!(self.eip & 0xFFF < 0xFFC);
        self.eip = increment_instruction_pointer(self.eip as i32, 4, self.asize_32(), self.cs_offset as i32) as u32;
    }
    #[allow(unused)]
    ...
    pub fn read_imm8(&mut self) -> u8 {
        ...
        self.eip = increment_instruction_pointer(self.eip as i32, 1, self.asize_32(), self.cs_offset as i32) as u32;
        v
    }
