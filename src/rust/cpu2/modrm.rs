...
pub unsafe fn resolve_modrm16(mut modrm_byte: i32) -> Result<i32, ()> {
    Ok(match modrm_byte {
        ...
        1 | 9 | 17 | 25 | 33 | 41 | 49 | 57 => get_seg_prefix_ds(
            *reg16.offset(BX as isize) as i32 + *reg16.offset(DI as isize) as i32 & 65535,
        ),
        ...
        2 | 10 | 18 | 26 | 34 | 42 | 50 | 58 => get_seg_prefix_ss(
            *reg16.offset(BP as isize) as i32 + *reg16.offset(SI as isize) as i32 & 65535,
        ),
        ...
        3 | 11 | 19 | 27 | 35 | 43 | 51 | 59 => get_seg_prefix_ss(
            *reg16.offset(BP as isize) as i32 + *reg16.offset(DI as isize) as i32 & 65535,
        ),
        ...
        4 | 12 | 20 | 28 | 36 | 44 | 52 | 60 => {
            get_seg_prefix_ds(*reg16.offset(SI as isize) as i32 & 65535)
        },
        68 | 76 | 84 | 92 | 100 | 108 | 116 | 124 => {
            get_seg_prefix_ds(*reg16.offset(SI as isize) as i32 + read_imm8s()? & 65535)
        },
        132 | 140 | 148 | 156 | 164 | 172 | 180 | 188 => {
            get_seg_prefix_ds(*reg16.offset(SI as isize) as i32 + read_imm16()? & 65535)
        },
        5 | 13 | 21 | 29 | 37 | 45 | 53 | 61 => {
            get_seg_prefix_ds(*reg16.offset(DI as isize) as i32 & 65535)
        },
        69 | 77 | 85 | 93 | 101 | 109 | 117 | 125 => {
            get_seg_prefix_ds(*reg16.offset(DI as isize) as i32 + read_imm8s()? & 65535)
        },
        133 | 141 | 149 | 157 | 165 | 173 | 181 | 189 => {
            get_seg_prefix_ds(*reg16.offset(DI as isize) as i32 + read_imm16()? & 65535)
        },
        6 | 14 | 22 | 30 | 38 | 46 | 54 | 62 => get_seg_prefix_ds(read_imm16()?),
        70 | 78 | 86 | 94 | 102 | 110 | 118 | 126 => {
            get_seg_prefix_ss(*reg16.offset(BP as isize) as i32 + read_imm8s()? & 65535)
        },
        134 | 142 | 150 | 158 | 166 | 174 | 182 | 190 => {
            get_seg_prefix_ss(*reg16.offset(BP as isize) as i32 + read_imm16()? & 65535)
        },
        7 | 15 | 23 | 31 | 39 | 47 | 55 | 63 => {
            get_seg_prefix_ds(*reg16.offset(BX as isize) as i32 & 65535)
        },
        71 | 79 | 87 | 95 | 103 | 111 | 119 | 127 => {
            get_seg_prefix_ds(*reg16.offset(BX as isize) as i32 + read_imm8s()? & 65535)
        },
        135 | 143 | 151 | 159 | 167 | 175 | 183 | 191 => {
            get_seg_prefix_ds(*reg16.offset(BX as isize) as i32 + read_imm16()? & 65535)
        },
        _ => {
            dbg_assert!(0 != 0);
            0
...
pub unsafe fn resolve_modrm32_(mut modrm_byte: i32) -> Result<i32, ()> {
    ...
    Ok(if r as i32 == 4 {
        ...
        if modrm_byte < 64 {
            ...
            get_seg_prefix_ss(
                *reg32s.offset(EBP as isize) + if modrm_byte < 128 {
                    read_imm8s()?
                }
                else {
                    read_imm32s()?
        ...
        get_seg_prefix_ds(
            *reg32s.offset(r as isize) + if modrm_byte < 128 {
                read_imm8s()?
            }
            else {
                read_imm32s()?
